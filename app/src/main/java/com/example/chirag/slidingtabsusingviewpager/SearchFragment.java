...
//            @Override // search view中的 x 应该解释为清楚词条,但目前先实现为跳转页面
//            public boolean onClose() {//仍然需要在action bar里创建一个cancel button来实现跳转功能。
//                FragmentManager fragmentManager = getFragmentManager();
//
//
//                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
...
//        intent.putExtra("query",query);
//        startActivity(intent);
////        //go to book info interface
////        Fragment bookInfoFragment = new BookInfoFragment();
////        bookInfoFragment.setArguments(bundle);
////        fragmentTransaction.add(R.id.content_frame, bookInfoFragment, "bookInfo");
////        fragmentTransaction.commit();
//
//
//        return true;
